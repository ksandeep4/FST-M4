-- Load data from HDFS
inputFile = LOAD 'hdfs:///user/ksandeep4/inputs/episodeVI_dialouges.txt' USING PigStorage('\t') AS ( name:chararray,line:chararray);
...
STORE nameOrdered INTO 'hdfs:///user/ksandeep4/outputs/episodeVIoutput' USING PigStorage('\t');