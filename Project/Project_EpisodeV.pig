-- Load data from HDFS
inputFile = LOAD 'hdfs:///user/ksandeep4/inputs/episodeV_dialouges.txt' USING PigStorage('\t') AS ( name:chararray,line:chararray);
...
STORE nameOrdered INTO 'hdfs:///user/ksandeep4/outputs/episodeVoutput' USING PigStorage('\t');